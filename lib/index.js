...
_commander2.default.command('list').description('list all migrations').option('-p, --pending', 'list only pending migrations').option('-e, --executed', 'list only executed migrations').option('-c, --connection').action(function (command) {
  if (command.pending) {
...
_commander2.default.command('seed').description('run all seed files in alphabetical order').option('-c, --connection').action(function (command) {
  rz.seed(command.connection);
});

_commander2.default.command('unseed').description('unseed the latest seed file').option('-c, --connection').action(function (command) {
