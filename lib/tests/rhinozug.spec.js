...
var promiseHelp = _interopRequireWildcard(_promiseHelper);
...
var up = sinon.stub().returns(Promise.resolve());
var down = sinon.stub().returns(Promise.resolve());
...
var sut = (0, _proxyquire2.default)('../rhinozug', {
...
describe('rhinozug module', function () {
  ...
  describe('.up()', function () {
    ...
    describe('when there is not an error', function () {
      ...
      it('should set the connection', function (done) {
        promiseHelp.testAfterPromise(sut.up(), function () {
      ...
      describe('when a file is specified', function () {
        it('should run migrations up to the specified file', function (done) {
          promiseHelp.testAfterPromise(sut.up('testFile.js'), function () {
  ...
  describe('.down()', function () {
    ...
    describe('when there is not an error', function () {
      ...
      it('should set the connection', function (done) {
        promiseHelp.testAfterPromise(sut.down(), function () {
          expect(process.env.connection).not.to.equal(null);
        }, done);
      });
      ...
      describe('when a file is specified', function () {
        it('should run migrations down to the specified file', function (done) {
          ...
          promiseHelp.testAfterPromise(sut.down('testFile.js'), function () {
  ...
  describe('.seed()', function () {
    ...
    describe('when there is not an error', function () {
      it('should set the connection', function (done) {
        promiseHelp.testAfterPromise(sut.seed(), function () {
          expect(process.env.connection).not.to.equal(null);
        }, done);
      });
  ...
  describe('.unseed()', function () {
    ...
    describe('when there is not an error', function () {
      ...
      it('should set the connection', function (done) {
        promiseHelp.testAfterPromise(sut.unseed(), function () {
          expect(process.env.connection).not.to.equal(null);
        }, done);
      });
  ...
  describe('.init()', function () {
    describe('when there is not an error', function () {
      ...
      it('should npm install the rhinozug connection module', function () {
        sut.init();
