...
describe('fileHelper module', function () {
  ...
  describe('.getDbDir', function () {
    describe('when a package.json is found in the project', function () {
      describe('when rhinozug has been initialized in the project', function () {
        beforeEach(setupReadDirSuccess);

        it('should return the directory where rhinozug was initialized', function () {
      ...
      describe('when rhinozug has not been initialized in the project', function () {
  ...
  describe('.getMigrationsPath()', function () {
    it('should return a path to the "migrations" directory in the directory where "rhinozug init" was called', function () {
